...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Take the column definitions and AdminLTE columns arrays and calculate how
	...
	{
		// On first run a AdminLTE variable is set, since this is only needed once.
	...
	{
		// Only extend API instances and AdminLTE properties of the API
	...
	DataTable.defaults = {
		 ...
		 * during initialisation in addition to through the AdminLTE
	...
	DataTable.ext = _ext = {
		 ...
		 * than just the AdminLTE string that DataTables knows of.
		 * 
