...
describe('CombinedActionTest', function() {
    ...
    it('construct', function(done) {
        ...
        var CombinedAction = EasyNode.using('easynode.framework.mvc.CombinedAction');
        var combinedAction = new CombinedAction();
        //ToDO
        //combinedAction.combine('m','a','m.a');
        //combinedAction.setProcessListener();
        //combinedAction.process;
        done();
    });
