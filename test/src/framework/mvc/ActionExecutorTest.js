...
describe('ActionExecutorTest', function() {
    ...
    it('execute', function(done) {
        ...
        var ActionExecutor = EasyNode.using('easynode.framework.mvc.ActionExecutor');
        var actionExecutor = new ActionExecutor();

        try{
            actionExecutor.execute(null,{});
        }catch(e){
            //ToDO
