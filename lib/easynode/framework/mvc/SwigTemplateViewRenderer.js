...
(function () {
  ...
  var SWITCH_CACHE = StringUtil.switchState(EasyNode.config('easynode.framework.mvc.view.template.enableCache', 'false'));
  ...
  var SwigTemplateViewRenderer = function (_ITemplateViewRendere) {
    _inherits(SwigTemplateViewRenderer, _ITemplateViewRendere);
    ...
    function SwigTemplateViewRenderer() {
      _classCallCheck(this, SwigTemplateViewRenderer);

      return _possibleConstructorReturn(this, Object.getPrototypeOf(SwigTemplateViewRenderer).call(this));
      // 调用super()后再定义子类成员。
    }

    _createClass(SwigTemplateViewRenderer, [{
      key: 'getCache',
    ...
    return SwigTemplateViewRenderer;
