    ...
    _createClass(ActionResult, [{
      ...
      value: function error() {
        ...
        if (msg == null && file != null) {
          ...
          msg = EasyNode.i18n('errors.' + code, 'easynode.framework.mvc.ActionResult');
        }
        this.code = code;
        this.msg = msg;
        this.result = {};
      ...
      value: function code2Message(code) {
        return EasyNode.i18n('errors.' + code, 'easynode.framework.mvc.ActionResult');
      }
      ...
      /**
       * 创建一个code为ActionResult.CODE_SIMULATE的ActionResult实例。它是CODE_SUCC的语义化功能。
       *
       * @method createSimulateResult
       * @return {easynode.framework.mvc.ActionResult}
       * @since 0.1.0
       * @author hujiabao
       * */
      ...
      key: 'createSimulateResult',
      value: function createSimulateResult(o) {
        return new ActionResult(ActionResult.CODE_SIMULATE, o);
      }
    }]);
