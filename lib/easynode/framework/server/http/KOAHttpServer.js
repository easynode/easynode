...
(function () {
        ...
        var HTTP_METHODS = ['all', //virtual method
        ...
        var KOAHttpServer = function (_AbstractServer) {
                _inherits(KOAHttpServer, _AbstractServer);
                ...
                function KOAHttpServer() {
                        var port = arguments.length <= 0 || arguments[0] === undefined ? S(EasyNode.config('easynode.servers.koa-HttpServer.port', '5000')).toInt() : arguments[0];

                        _classCallCheck(this, KOAHttpServer);
                        ...
                        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(KOAHttpServer).call(this, port, EasyNode.config('easynode.servers.koa-HttpServer.name', 'koa-HttpServer')));
                         ...
                         * @author hujiabao
                         * */
                        _this.setWebRoot = function (webRoot) {
                         ...
                         * @author hujiabao
                         * */
                        _this.setUploadDir = function (uploadDir) {
                         ...
                         * @author allen.hu
                         */
                        _this.getUploadURIPrefix = function () {
                         ...
                         * @author hujiabao
                         * */
                        _this.writeAccessLog = function (flag) {
                         ...
                         * @private
                         * */
                        _this._sessionStorage = 'storage-memory';
                        /**
                         *  Session 存储选项，默认null
                         ...
                         * @private
                         * */
                        _this._sessionStorageOptions = null;
                         ...
                         * @private
                         * */
                        _this._keys = EasyNode.config('easynode.servers.koa-HttpServer.keys', 'EasyNode').split(',');
                ...
                _createClass(KOAHttpServer, [{
                        key: 'addWebDirs',
                        value: function addWebDirs() {
                                var _this2 = this;
                        ...
                        key: 'addTemplateDirs',
                        value: function addTemplateDirs() {
                                var _this3 = this;
                        ...
                        * */
                        ...
                        key: 'addMiddleware',
                        value: function addMiddleware(gen) {
                        ...
                        key: 'addMiddlewareAfterRoutes',
                        value: function addMiddlewareAfterRoutes(gen) {
                        ...
                        key: 'addRoute',
                        value: function addRoute(method, uri, gen) {
                        ...
                        value: function setSessionStorage(storage, opt) {
                                assert(typeof storage == 'string', 'Invalid argument');
                                assert(_.contains([KOAHttpServer.SessionSupport.STORAGE_MEMORY, KOAHttpServer.SessionSupport.STORAGE_REDIS, KOAHttpServer.SessionSupport.STORAGE_MEMCACHED], storage), 'Invalid session storage [' + storage + ']');
                        ...
                        key: 'enableCSRF',
                        value: function enableCSRF(flag) {
                                assert(typeof flag == 'boolean', 'Invalid argument');
                        ...
                        key: 'enable404Middleware',
                        value: function enable404Middleware(flag) {
                                assert(typeof flag == 'boolean', 'Invalid argument');
                        ...
                        key: '_getSessionStore',
                        value: function _getSessionStore() {
                        ...
                        key: '_createMemoryStorage',
                        value: function _createMemoryStorage() {
                        ...
                        key: '_createRedisStorage',
                        value: function _createRedisStorage() {
                        ...
                        key: '_createMemcachedStorage',
                        value: function _createMemcachedStorage() {
                        ...
                        key: '_createAccessLogger',
                        value: function _createAccessLogger() {
                                var me = this;
                        ...
                        key: '_createDefaultRoutes',
                        value: function _createDefaultRoutes(app) {
                        ...
                        key: '_createExtraRoutes',
                        value: function _createExtraRoutes(app) {
                                this._routes = this._routes || [];
                                this._routes.forEach(function (o) {
                        ...
                        key: '_createExtraMiddlewares',
                        value: function _createExtraMiddlewares(app) {
                                this._middlewares = this._middlewares || [];
                        ...
                        key: '_createDefaultMiddlewares',
                        value: function _createDefaultMiddlewares(app) {
                        ...
                        key: '_createMultipartMiddleware',
                        value: function _createMultipartMiddleware(app) {
                        ...
                        key: '_createMiddlewaresAfterRoutes',

                        // }
                        value: function _createMiddlewaresAfterRoutes(app) {
                                this._middlewaresAfterRoutes = this._middlewaresAfterRoutes || [];
                                this._middlewaresAfterRoutes.forEach(function (middleware) {
                                        app.use(middleware);
                                });
                        }
                        /**
                        ...
                        key: '_addExtraWebDirs',
                        value: function _addExtraWebDirs(app) {
                                this._webDirs = this._webDirs || [];
                                this._webDirs.forEach(function (dir) {
                        ...
                        key: '_addTemplate',
                        value: function _addTemplate(app) {
                                this._templateDirs = this._templateDirs || [];
                                this._templateDirs.forEach(function (dir) {
                                        render(app, {
                        ...
                        value: function start() {
                                ...
                                return regeneratorRuntime.mark(function _callee6() {
                                        var app, csrf, nginxConfTemplate, nginxVPTemplate, sCfg, sVP, extraDirs, vpRegexp, i, p, vp, nginxConfigFile, fnListen;
                                                        ...
                                                        switch (_context6.prev = _context6.next) {
                                                                case 0:
                                                                                ...
                                                                                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                                                                                        while (1) {
                                                                                                switch (_context4.prev = _context4.next) {
                                                                                                        case 0:
                                                                                                                req = this.req;
                                                                                                                address = req.headers[PROXY_IP_HEADER] || req.connection && req.connection.remoteAddress || req.socket && req.socket.remoteAddress || req.connection.socket && req.connection.socket.remoteAddress || '0.0.0.0';
                                                                        ...
                                                                        if (me._enable404Middleware !== false) {
                                                                                app.use(regeneratorRuntime.mark(function _callee5() {
                                                                                        var uri, content404, config404, page404;
                                                                                                ...
                                                                                                while (1) {
                                                                                                        switch (_context5.prev = _context5.next) {
                                                                                                                case 0:
                                                                                                                        ...
                                                                                                                        uri = this.url.replace(/\?.*$/gm, '');
                                                                                                                        content404 = me._404Content;
                                                                                                                        ...
                                                                                                                        config404 = EasyNode.config('easynode.servers.koa-HttpServer.404', '404.html');
                                                                                                                        page404 = path.join(me.getWebRoot(), config404);
                                                                                                                        content404 = '<h1>404 Resource Not Found : ${URI}</h1>';
                                                                                                                        _context5.next = 10;
                                                                                                                        return fs.exists(page404);
                                                                                                                ...
                                                                                                                case 10:
                                                                                                                        ...
                                                                                                                        _context5.next = 13;
                                                                                                                        return fs.readFile(page404);

                                                                                                                case 13:
                                                                                                                        content404 = _context5.sent;
                                                                        ...
                                                                        nginxConfTemplate = EasyNode.real('etc/nginx-conf.mst');
                                                                        nginxVPTemplate = EasyNode.real('etc/nginx-vp-conf.mst');
                                                                        sCfg = '';
                                                                        sVP = '';
                                                                        extraDirs = me.getWebDirs();
                                                                        vpRegexp = /.*\/(.+)\/www\/?$/;
                                                                        //virtual path
                                                                ...
                                                                case 28:
                                                                        ...
                                                                        _context6.next = 35;
                                                                        return MustacheHelper.renderFile(nginxVPTemplate, {
                                                                                virtualPathName: vp,
                                                                ...
                                                                case 40:
                                                                        _context6.next = 42;
                                                                        return MustacheHelper.renderFile(nginxConfTemplate, {
                                                                ...
                                                                case 42:
                                                                        sCfg = _context6.sent;
                                                                        nginxConfigFile = EasyNode.real('etc/nginx.conf');
                                                                        _context6.next = 46;
                                                                        return fs.writeFile(nginxConfigFile, sCfg);

                                                                case 46:
                                                                        logger.info('nginx config file is auto-generated at [' + nginxConfigFile + ']');

                                                                case 47:
                                                                        fnListen = thunkify(app.listen);
                                                                        _context6.next = 50;
                                                                        return fnListen.call(app, me.port);
